...
# Docker parameters
EXECUTABLE=github.com/templwind/echo-sass-starter
NAMESPACE=echo-sass-starter
DOCKER=docker
...
help: Makefile
	@echo
	@echo " Application Name: github.com/templwind/echo-sass-starter"
	@echo
...
build:
	make templ-generate
	go build -ldflags "-X main.Environment=production" -o ./tmp/github.com/templwind/echo-sass-starter .
...
xo:
	...
	@xoclir parsexo -i ./internal/models -o ./internal/models -b github.com/templwind/sass-starter/internal
	@go mod tidy
